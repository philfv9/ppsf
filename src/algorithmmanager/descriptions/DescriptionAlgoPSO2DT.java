 ...
 */
public class DescriptionAlgoPSO2DT extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoPSO2DT(){
	...
	public void runPPMFAlgorithm(String[] parameters, String inputDatabaseFile, String inputSensitiveFile, String outputFile) throws IOException {
		...
		algorithms.PPDM.PSO2DT.AlgoPSO2DT algorithm = new algorithms.PPDM.PSO2DT.AlgoPSO2DT();

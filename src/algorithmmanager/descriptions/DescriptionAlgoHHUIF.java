 ...
 */
public class DescriptionAlgoHHUIF extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoHHUIF(){
	...
	public void runPPMFAlgorithm(String[] parameters, String inputDatabaseFile, String inputSensitiveFile, String outputFile) throws IOException {
		...
		algorithms.PPUM.AlgoHHUIF algorithm = new algorithms.PPUM.AlgoHHUIF();

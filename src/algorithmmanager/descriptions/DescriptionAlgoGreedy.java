 ...
 */
public class DescriptionAlgoGreedy extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoGreedy(){
	...
	public void runPPMFAlgorithm(String[] parameters, String inputDatabaseFile, String inputSensitiveFile, String outputFile) throws IOException {
		...
		algorithms.PPDM.Greedy.AlgoGreedy algorithm = new algorithms.PPDM.Greedy.AlgoGreedy();

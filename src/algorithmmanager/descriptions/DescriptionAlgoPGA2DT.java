 ...
 */
public class DescriptionAlgoPGA2DT extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoPGA2DT(){
	...
	public void runPPMFAlgorithm(String[] parameters, String inputDatabaseFile, String inputSensitiveFile, String outputFile) throws IOException {
		...
		// Applying the Apriori algorithm, optimized version
		algorithms.PPDM.pGA2DT.AlgoPGA2DT algorithm = new algorithms.PPDM.pGA2DT.AlgoPGA2DT();

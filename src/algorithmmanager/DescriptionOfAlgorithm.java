...
public abstract class DescriptionOfAlgorithm {
	 ...
	 */
	public abstract void runAlgorithm(String[] parameters, String inputDatabaseFile,
			String outputFile) throws Exception;
	
	public abstract void runPPMFAlgorithm(String[] parameters, String input1, String input2, 
			String outputFile) throws Exception;

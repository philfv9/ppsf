...
public class PreferencesManager {   
    ...
    public static final String REGKEY_SPMF_INPUT_FILE = "inputDatasetsFile";
    public static final String REGKEY_SPMF_OUTPUT_FILE = "outputFile";
    public static final String REGKEY_SPMF_SENSITIVE_INPUT_FILE = "inputSensitiveFile";
    
    public static final String REGKEY_SPMF_PREFERED_CHARSET = "gui.charset";
    ...
    /**
     * Get the input sensitive file path stored in the registry
     * @return a path as a string
     */
    public String getInputSensitiveFilePath() {
        //      read back from registry HKCurrentUser
        Preferences p = Preferences.userRoot();
        return p.get(REGKEY_SPMF_SENSITIVE_INPUT_FILE, null);
    }
     ...
     */
    public void setInputSensitiveFilePath(String filepath) {
        // write into HKCurrentUser
        Preferences p = Preferences.userRoot();
        p.put(REGKEY_SPMF_SENSITIVE_INPUT_FILE, filepath);
    }
